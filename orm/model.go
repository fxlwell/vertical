...
func (m *M) Bool(k string) bool {
	return vertical_util.As_bool(m.E[k])
}
func (m *M) Int(k string) int {
	return vertical_util.As_int(m.E[k])
}
func (m *M) Int8(k string) int8 {
	return vertical_util.As_int8(m.E[k])
}
func (m *M) Int16(k string) int16 {
	return vertical_util.As_int16(m.E[k])
}
func (m *M) Int32(k string) int32 {
	return vertical_util.As_int32(m.E[k])
}
func (m *M) Int64(k string) int64 {
	return vertical_util.As_int64(m.E[k])
}
func (m *M) Uint(k string) uint {
	return vertical_util.As_uint(m.E[k])
}
func (m *M) Uint8(k string) uint8 {
	return vertical_util.As_uint8(m.E[k])
}
func (m *M) Uint16(k string) uint16 {
	return vertical_util.As_uint16(m.E[k])
}
func (m *M) Uint32(k string) uint32 {
	return vertical_util.As_uint32(m.E[k])
}
func (m *M) Uint64(k string) uint64 {
	return vertical_util.As_uint64(m.E[k])
}
func (m *M) Float32(k string) float32 {
	return vertical_util.As_float32(m.E[k])
}
func (m *M) Float64(k string) float64 {
	return vertical_util.As_float64(m.E[k])
}
func (m *M) String(k string) string {
	return vertical_util.As_string(m.E[k])
}
